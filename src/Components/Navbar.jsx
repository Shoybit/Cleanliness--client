            ...
            <div className="hidden md:flex space-x-6 items-center">
              {user ? (
                <>
                  <Link 
                    to="/" 
                    className={` transition ${isActive("/") ? "text-green-600 font-semibold" : " hover:text-green-600  dark:text-white"}`}
                  >
                    Home
                  </Link>
                  <Link 
                    to="/all-issues" 
                    className={`transition ${isActive("/all-issues") ? "text-green-600 font-semibold" : "text-black hover:text-green-600 dark:text-white"}`}
                  >
                    All Issues
                  </Link>
                  <Link 
                    to="/addissue" 
                    className={`transition ${isActive("/addissue") ? "text-green-600 font-semibold" : "text-black hover:text-green-600 dark:text-white"}`}
                  >
                    Add Issues
                  </Link>
                  <Link 
                    to="/my-issues" 
                    className={`transition ${isActive("/my-issues") ? "text-green-600 font-semibold" : "text-black hover:text-green-600 dark:text-white"}`}
                  >
                    My Issues
                  </Link>
                  <Link 
                    to="/my-contribution" 
                    className={`transition ${isActive("/my-contribution") ? "text-green-600 font-semibold" : "text-black hover:text-green-600 dark:text-white"}`}
                  >
                    My Contribution
                  </Link>
                ...
                <>
                  <Link 
                    to="/" 
                    className={`transition ${isActive("/") ? "text-green-600 font-semibold" : "text-black hover:text-green-600 dark:text-white"}`}
                  >
                    Home
                  </Link>
                  <Link 
                  ...
                  <Link to="/login" className="px-4 py-2 rounded-md bg-green-600 text-white hover:bg-green-700 transition dark:text-white">
                    Login
                  </Link>
                  <Link to="/register" className="px-4 py-2 rounded-md bg-green-600 text-white hover:bg-green-700 transition dark:text-white">
                    Register
                  </Link>
                </>
              )}
