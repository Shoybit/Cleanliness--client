    ...
    <div className="max-w-10/12 mx-auto px-4 py-12">
      ...
      <div className="text-center mb-10 flex flex-col items-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 flex items-center gap-2">
          <FaTasks className="text-green-500" size={28}></FaTasks>
          Report Categories
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {categories.map((category, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center p-6 rounded-xl shadow-lg hover:shadow-2xl transition transform hover:scale-105 cursor-pointer"
          >
            <div
